...
public class MainEvent_1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        InvokeRepeating("Force_Change", 25, 1.0f);
    ...
    void Feedback_Change()
    {
        ...
        Shuttle.GetComponent<AudioSource>().volume -= feedback_changer * 10.0f;
        Table.GetComponent<AudioSource>().volume -= feedback_changer * 10.0f;
    }

    void Force_Change()
    {
        Shuttle.GetComponent<OrbitCorrection>().CollectionForce += force_changer;
    ...
    void Speed_Variety_Change()
    {
        ...
        if (level == 1)
        {
            ...
            speed_count = 100;
            speed_variety = (speed_target - 1.1f) / speed_count;
    ...
    void Update()
    {
        ...
        if (Shuttle.GetComponent<OrbitCorrection>().CollectionForce >= 0.000005f)
        {
            force_changer = 0.0f;
        }
